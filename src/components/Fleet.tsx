...
const VEHICLE_IMAGES = [
  {
    image: '/5.webp',
    altDe: 'Mercedes-Benz S-Klasse Luxus-Limousine - VipShuttle24 Premium Chauffeur Düsseldorf',
    altEn: 'Mercedes-Benz S-Class Luxury Sedan - VipShuttle24 Premium Chauffeur Düsseldorf',
  },
  {
    image: '/20.jpeg',
    altDe: 'Mercedes-Benz E-Klasse Business-Limousine - VipShuttle24 Chauffeur Service NRW',
    ...
    <>
      <section id="fleet" className="py-16 lg:py-32 bg-dusk relative overflow-hidden" aria-label={f.sectionLabel}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {/* Vehicle grid */}
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 md:gap-6 max-w-7xl mx-auto">
